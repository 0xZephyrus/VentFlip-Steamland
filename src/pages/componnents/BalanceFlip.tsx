  ...
  return (
    <div className="w-[380px] h-[230px] md:w-[380px] md:h-[230px] bg-[#292A2D]  bg-opacity-95 border-4 border-black shadow p-2 rounded-2xl">
      ...
      <div className=" grid grid-rows-1 grid-cols-1  gap-2 items-center justify-center text-center ">
        <div className="bg-[#756394]  h-[50px] w-[100px] rounded-lg text-2xl text-white  font-bold justify-center  items-center flex ">
          Balance
        </div>
        ...
        <div className=" col-span-2  ">
          <button
            className="  bg-[#756394]  text-white  hover:text-black hover:bg-[#F3CE49] justify-center  items-center flex gap-4  text-2xl h-[55px] w-full rounded-lg font-bold "
